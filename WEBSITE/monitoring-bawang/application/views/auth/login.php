          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                ...
                <img class="mx-auto img-fluid" src="<?= base_url('assets/img/logo.png'); ?>" alt="logo" width="150">
                </div>
              </div>
              <div class="card-body">
                <form method="post" action="<?= base_url('auth/proses'); ?>">
                  <div class="row">
                    <div class="col">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="email" name="email" autocomplete="off" placeholder="Enter Email Address...">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="text-center">
                    <button type="submit" class="text btn btn-fill btn-primary mt-3">Login</button>
                  </div>
                </form>
              </div> 
            </div>
